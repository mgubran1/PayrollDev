...
public class LoadsTab extends Tab implements EmployeesTab.EmployeeDataChangeListener,
    ...
    /**
     * Show the load dialog for adding or editing a load.
     * This method exposes the LoadsPanel's showLoadDialog functionality.
     * 
     * @param load The load to edit, or null to create a new load
     * @param isAdd True to add a new load, false to edit existing
     */
    public void showLoadDialog(Load load, boolean isAdd) {
        logger.debug("ShowLoadDialog requested - isAdd: {}, load: {}", isAdd, 
