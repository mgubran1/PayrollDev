...
public class PDFExporter {
    ...
    // Column width percentages for revenue table (must sum to 1.0f)
    private static final float DRIVER_COLUMN_WIDTH_PERCENTAGE = 0.40f;
    private static final float OTHER_COLUMN_WIDTH_PERCENTAGE = 0.15f;
