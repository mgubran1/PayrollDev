...
public class PayrollRecurringPanel extends VBox {
    ...
    private final Button addFeeBtn = ModernButtonStyles.createSuccessButton("Add Deduction");
    private final Button removeFeeBtn = ModernButtonStyles.createDangerButton("Remove");
    private final Button saveFeesBtn = ModernButtonStyles.createPrimaryButton("Save This Week's Deductions");
    private final Button chargeAllBtn = ModernButtonStyles.createWarningButton("Charge All Recurring Fees");
