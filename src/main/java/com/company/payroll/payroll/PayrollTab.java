...
public class PayrollTab extends BorderPane implements 
    ...
    // Helper classes
    private static class PayrollHistoryEntry {
        final LocalDate date;
        final String driverName;
        final String truckUnit;
        final int loadCount;
        final double gross;
        ...
        PayrollHistoryEntry(LocalDate date, String driverName, String truckUnit, int loadCount,
                          double gross, double totalDeductions, double netPay, boolean locked) {
            this.date = date;
    ...
    private static class CheckBoxListCell<T> extends ListCell<T> {
        ...
        protected void updateItem(T item, boolean empty) {
            ...
            if (empty || item == null) {
                ...
                // Format the text based on the item type
	    ...
	    // Inner class for progress dialogs
    private static class ProgressDialog<T> extends Dialog<T> {
        ...
        public ProgressDialog(Task<T> task) {
            ...
            // Only allow closing when task is done
            ...
            // Disable close button while running
