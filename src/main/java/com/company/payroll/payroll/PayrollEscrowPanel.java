...
public class PayrollEscrowPanel extends BorderPane {
    ...
    private VBox createHeaderSection() {
        ...
        // Update button
        updateTargetButton = ModernButtonStyles.createSuccessButton("Update");
    ...
    private HBox createActionButtons() {
        ...
        Button addDepositBtn = ModernButtonStyles.createSuccessButton("➕ Add Deposit");
        addDepositBtn.setOnAction(e -> showAddDepositDialog());
        
        Button withdrawBtn = ModernButtonStyles.createWarningButton("➖ Withdraw");
