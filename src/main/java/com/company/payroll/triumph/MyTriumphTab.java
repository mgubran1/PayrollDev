...
public class MyTriumphTab extends Tab {
    ...
    private Node buildPanel() {
        ...
        Button syncFromLoadsBtn = new Button("Sync from Loads");
        Button copyUnbilledBtn = new Button("Copy Unbilled for Excel");
    ...
    private void handleCopyUnbilledForExcel() {
        ...
        Button applyMonthBtn = new Button("Apply Selected Month");
